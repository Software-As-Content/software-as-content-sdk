...
AVAILABLE_MODELS: list[ModelOption] = [
    ...
    ModelOption(id="google/gemini-3.5-flash", name="Gemini 3.5 Flash", provider="google"),
    ModelOption(id="google/gemini-3-flash-preview", name="Gemini 3 Flash", provider="google"),
    # Anthropic Claude
    ModelOption(id="anthropic/claude-opus-4.7", name="Claude Opus 4.7", provider="anthropic"),
    ModelOption(id="anthropic/claude-sonnet-4.6", name="Claude Sonnet 4.6", provider="anthropic"),
    ModelOption(id="anthropic/claude-haiku-4.5", name="Claude Haiku 4.5", provider="anthropic"),
    # OpenAI GPT
    ModelOption(id="openai/gpt-5.5-pro", name="GPT-5.5 Pro", provider="openai"),
    ...
    # xAI Grok
    ModelOption(id="x-ai/grok-4.3", name="Grok 4.3", provider="xai"),
    ModelOption(id="x-ai/grok-4.20", name="Grok 4.20", provider="xai"),
    # DeepSeek
    ModelOption(id="deepseek/deepseek-v4-pro", name="DeepSeek V4 Pro", provider="deepseek"),
